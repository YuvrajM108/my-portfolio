  ...
  return (
    <div className="App">
      ...
      <div className="bio" id="bio">
        ...
        <section className="what-i-do">
          ...
          <p className="what-i-do">
            I am a front-end oriented developer who builds dynamic web applications using a variety
      ...
      <div className="contact" id="contact">
        ...
        <h3 className="preview-note">Get in touch and let us work together!</h3>
        <div className="contact-links">
          ...
          <p className="contact-text">©2023 Yuvraj Manoo</p>
        </div>
      </div>
    </div>
  );
